    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
          ...
          endIndent : 20,       
             ...
             const Text("La Mascotte", style: TextStyle(fontWeight: FontWeight.bold,fontSize: 30,color: Color.fromARGB(255, 10, 131, 231)),),
            const Text(style: TextStyle(fontSize: 20),"La mascotte de l’Expo 2025 Osaka Kansai, appelée Myaku-Myaku, s’inspire du logo de l’Exposition et de l’eau – symbole d’Osaka, la « cité de l’eau ». Myaku–Myaku est polymorphe et fluide  ses cellules rouges peuvent être séparées et son corps peut changer de forme librement selon d’infinies variations."),
